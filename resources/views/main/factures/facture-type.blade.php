...
<style>
  ...
  <center><h1 style='color:black;background: -webkit-linear-gradient(rgb(255 205 45), rgb(255 87 87));-webkit-background-clip: text;-webkit-text-fill-color: transparent;'>Choisier votre Facture preferé:</h1></center>
<div class="container">
    <div class="row">
