...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
             ...
             <a href="/facture/create?t=bl&Ex=3" ><img src="{{asset('imgs/facts/bl2.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>    
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
              <button style="margin-left:3px;" class="btn btn-primary  mb-2" type="submit">
             ...
             <a href="/facture/create?t=bl&Ex=4" ><img src="{{asset('imgs/facts/bl3.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
           <button style="margin-left:3px; " class="btn btn-primary  mb-2" type="submit">
             ...
             <a href="/facture/create?t=bl&Ex=5" ><img src="{{asset('imgs/facts/bl4.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
      ...
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
             ...
             <a href="/facture/create?t=bl&Ex=6" ><img src="{{asset('imgs/facts/bl5.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>    
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
              <button style="margin-left:3px;" class="btn btn-primary  mb-2" type="submit">
             ...
             <a href="/facture/create?t=bl&Ex=7" ><img src="{{asset('imgs/facts/bl6.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
           <button style="margin-left:3px; " class="btn btn-primary  mb-2" type="submit">
             ...
             <a href="/facture/create?t=bl&Ex=8" ><img src="{{asset('imgs/facts/bl7.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
                <button style="margin-left:3px;"  class="btn btn-primary  mb-2" type="submit">
            ...
            <a href="/facture/create?t=bl&Ex=9" ><img src="{{asset('imgs/facts/bl8.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
      ...
      <div class="col-md-4 col-12  a mt-2 border rounded-start border-warning">
             ...
             <a href="/facture/create?t=bl&Ex=1" ><img src="{{asset('imgs/facts/bl9.PNG')}}" class="img-fluid rounded-start" alt="..."></a>
      </div>
